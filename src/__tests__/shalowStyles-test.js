...
describe('shallowStyles', () => {
  ...
  it('should shallowStyles add prefix', () => {
    ...
    expect(styles).toContain('.mw-');
    expect(styles).toContain('{moz-box-shadow:10px 35px 1px blue;box-shadow:10px 35px 1px blue;}');
  })
  ...
  it('should shallowStyles remove redundances', () => {
    ...
    expect(styles).toEqual('.header,.my-other-wrapper{color:#333;}.header{background:#F9F9F9;font-size:20px;}.wrapper{color:#f8f8f8;background:blue;border-rigth:1px solid #333;}.my-other-wrapper{font-size:15px;position:absolute;}');
  })
